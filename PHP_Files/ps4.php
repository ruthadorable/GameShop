...
<div class="row">
    <div class="col-sm-4">
        <div class="card">
            <div class="card-header"><img src="images/ps4slim.jpg" width='425px' height='250px'class="img-fluid"></div>
            <div class="card-body">
                <h2>Console PS4 Noir</h2>
                <p>Prix: 290 euros </p>
                <p> <h3>Description du produit</h3>

                Que vous soyez dans le salon ou dans votre chambre, une PlayStation 4 Slim permet de jouer aux jeux les plus récents comme FIFA, F1 Racing et Call of Duty.
                L'élégante PS4 Slim est plus petite, plus fine et plus économe qu'une PS4 Pro ; vous pourrez donc l'intégrer dans votre intérieur sans qu'elle ne gêne.
                Jouer, regarder des films Blu-ray ou streamer de la musique depuis Spotify : avec la PS4 Slim, vous ferez tout ça avec un seul appareil.</p>
            </div>
    ...
    <div class="col-sm-4">
        <div class="card">
            ...
            <div class="card-footer"><button type="button" class="btn btn-danger">Promotion</button></div>
        </div>
    </div>
</div>
