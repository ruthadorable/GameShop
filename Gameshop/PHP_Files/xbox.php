...
<div class="row">
    <div class="col-sm-6">
        <div class="card">
            <div class="card-header"><img src="images/xboxoneconsole.jpg" width='425px' height='250px'class="img-fluid"></div>
            <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Plus d'infos</button>
                <div id="demo" class="collapse">
                    <br><br>
                    <h4>Caractéristiques du produit<br>
                        Avantages et inconvénients</h4>
                    <i>D'après notre expert console</i>
                    <p>
                        Avantages :<br>
                    <ul>
                        <li>La Xbox One X fait tourner tous les jeux Xbox One en résolution 4K avec des détails améliorés. </li>
                        <li>Grâce au lecteur Ultra HD Blu-ray intégré, vous profiterez de vos films dans la plus haute qualité. </li>
                        <li>Le refroidissement liquide assure que la Xbox One X sera quasiment silencieuse même lors d'une utilisation intensive. </li>

                    </ul>

                    Inconvénients :
                    <ul><li>Le pack n'est pas fourni avec une seconde manette pour jouer à plusieurs. </li>
                        <li>Il vous faudra une télévision ou un écran 4K pour tirer le meilleur parti de la Xbox One X. </li>
                    </ul>
    ...
    <div class="col-sm-6">
        <div class="card">
                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/PackXboxoneXSEFalloutBlanc.jpg" class="img-fluid" width="1100" height="500">
            ...
            <div class="card-body">
                <h2>Pack Xbox One X Special Edition Fallout 76 Blanc</h2>
            ...
            <div class="card-footer">
                ...
                <div id="demo" class="collapse">
                    ...
                    Inconvénients :
                    <ul>
                        <li>Le pack n'est pas fourni avec une seconde manette pour jouer à plusieurs.</li>
                        <li>Il vous faudra une télévision ou un écran 4K pour tirer le meilleur parti de la Xbox One X. </li>
